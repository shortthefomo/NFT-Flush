    ...
    <div class="p-5 mb-4 bg-light rounded-3">
        <div class="container-fluid py-5">
            ...
            <p class="col-md-12 fs-4">
                <p class="text-center">
                    <a v-if="account != ''" class="btn btn-purple me-2" @click="flushAll" role="button" id="flushAll" v-bind:disabled="hasOffers">flush all</a>
                    <a v-if="account != ''" class="btn btn-pink me-2" @click="flushSelected" role="button" id="flushSelected" v-bind:disabled="hasSelected">flush selected</a>
                </p>
            </p>
        </div>
    </div>
